# lesson4_dz
п 1. Тестирование REST сервиса 1
...
п 2. Тестирование REST сервиса 2
...
п 4. Реализуйте в отдельном модуле (файле) тестовую функцию которая будет принимать 2 параметра:
